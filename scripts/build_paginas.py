...
<body><div class="wrap">
<nav class="tabs noprint"><a href="analiticas.html" id="t-ana">◔ Analytics</a><a href="noticias.html" id="t-not">📰 Noticias</a><a href="29-evergreen.html" id="t-home">⌂ Inicio</a></nav>
__BODY__
</div>
<script>
...
"08-atlas-kanban": {d:"Manrope", b:"Manrope", bg:"#F4F7FA", card:"#FFFFFF", ink:"#10202E", mut:"#5B6B7B", acc:"#0284C7", acctext:"#FFFFFF", rad:"12px"},
...
"16-cave-git": {d:"IBM Plex Mono", b:"IBM Plex Mono", bg:"#0D1117", card:"#161B22", ink:"#E6EDF3", mut:"#8B949E", acc:"#2F81F7", acctext:"#FFFFFF", rad:"6px"},
...
function applyTema(){
  ...
  if (th) th.href = (T ? T + '.html' : '29-evergreen.html') + '?mod=' + module;
  if (!T) return;
...
function setModule(m){
  ...
  if (th) th.href = (temaActual() ? temaActual() + '.html' : '29-evergreen.html') + '?mod=' + m;
  render();
}
